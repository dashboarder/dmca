...
#if (DISP_VERSION > 4)
#define rDPCWBSTRD(n)			(*(volatile u_int32_t *)(DISPLAYPIPE_BASE_ADDR + (0x4 * (n)) + 0x1068))
#define  DPCWBSTRD_DSTBURST_1BLOCK	(0 << 0)
#define  DPCWBSTRD_DSTBURST_2BLOCKS	(1 << 0)
#define  DPCWBSTRD_DSTBURST_4BLOCKS	(2 << 0)
#define  DPCWBSTRD_DSTBURST_8BLOCKS	(3 << 0)
#define  DPCWBSTRD_DSTBURST_MASK	(3 << 0)
#define  DPCWBSTRD_DSTSTRIDE_MASK	(~0x3F)
#endif
...
#if (DISP_VERSION > 4)
#define rDPVREQCFG(n)			(*(volatile u_int32_t *)(DISPLAYPIPE_BASE_ADDR + (0x4 * (n)) + 0x3050))
#define	DPVREQCFG_REQ_CNT(_n)		((_n) & 0xFF)
#define DPVREQCFG_CACHEHINT_MASK	(7 << 8)
#endif

#define rDPVSRCSTRD(n)			(*(volatile u_int32_t *)(DISPLAYPIPE_BASE_ADDR + (0x4 * (n)) + 0x3088))
#define  DPVSRCSTRD_SRCBURST_1BLOCK	(0 << 0)
#define  DPVSRCSTRD_SRCBURST_2BLOCKS	(1 << 0)
#define  DPVSRCSTRD_SRCBURST_4BLOCKS	(2 << 0)
#define  DPVSRCSTRD_SRCBURST_8BLOCKS	(3 << 0)
#define  DPVSRCSTRD_SRCBURST_MASK	(3 << 0)
#define  DPVSRCSTRD_SRCSTRIDE_MASK	(~0x3F)

#if (DISP_VERSION > 4)
#define rDPUREQCFG(n)			(*(volatile u_int32_t *)(DISPLAYPIPE_BASE_ADDR + (0x1000 * (n)) + 0x403C))
#define	DPUREQCFG_REQ_CNT(_n)		((_n) & 0xFF)
#define DPUREQCFG_CACHEHINT_MASK	(7 << 8) 
#endif
