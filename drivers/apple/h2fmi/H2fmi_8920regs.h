...
#define FMI_OFFSET                (0x000)
#define FMC_OFFSET                (0x400)
#define ECC_OFFSET                (0x800)
...
// These values have not been validated, but they are not used for H2P products
#define FMI_TX_PROP_DELAY_NS                  (15)
#define FMI_RX_PROP_DELAY_NS                  (15)

#endif // _H2FMI_8920REGS_H_
