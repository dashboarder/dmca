...
#define FMC_DQS_TIMING_CTRL__DQS_READ_DELAY_COARSE_CTRL(x) (((x) & 0x7F) << 18)
#define FMC_DQS_TIMING_CTRL__DQS_READ_DELAY_FINE_CTRL(x)   (((x) & 0x3) << 16)
#define FMC_DQS_TIMING_CTRL__DQS_WRITE_DELAY_TIMING(x)     (((x) & 0xF) << 0)

#define FMC_DQS_TIMING_CTRL__DEFAULT_VAL                   (0x00800000)
...
#define FMI_TX_PROP_DELAY_NS                  (7)
#define FMI_RX_PROP_DELAY_NS                  (5)

#define FMI_USE_WRITE_CYCLE_BALANCING         (1)
