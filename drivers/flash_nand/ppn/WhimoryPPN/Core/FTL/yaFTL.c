...
static BOOL32 YAFTL_GetStruct(UInt32 dwStructType, void * pvoidStructBuffer, UInt32 * pdwStructSize)
{
    ...
    {
        UInt32 sbIndex;
        UInt32 numBufEntries = (*pdwStructSize) / sizeof(UInt16);
        UInt16 *sbEraseCnts = (UInt16 *) pvoidStructBuffer;   
        UInt32 numSBlks = (UInt32)FTL_AREA_SIZE;
        ...
        for (sbIndex=0; sbIndex < numSBlks; sbIndex++){
            sbEraseCnts[sbIndex] = (UInt16) (yaFTL.blockArray[sbIndex].erasableCount);
        }   
