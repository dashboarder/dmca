...
static const struct amc_param amc_params = {
	.flags     	 	= (FLAG_AMC_PARAM_SLOW_BOOT | FLAG_AMC_PARAM_RECONFIG | FLAG_AMC_PARAM_ENABLE_AIU | FLAG_AMC_PARAM_MRR_BYTE_SWIZZLE | FLAG_AMC_PARAM_MRR_BIT_SWIZZLE),
	...
	.pwrmngtparam_guided	= 0x03001000,
	.chnldec		= 0x00000100,
	.chnldec2		= 0x003ffffd,
...
static const struct amc_tunable amc_tunables[] = {
	...
	{ &rAMC_ADDRMAP_MODE,		0x00000002 },		// RIBI2 achieves much better performance for both linear and tiled mode frame buffers, and has better power profile as well
	{ &rAMC_PWRMNGTPARAM,		0x03001000 },		// Use AiuReq to exiting self refresh state.

	// Platform specific
	
	{ &rAMC_AIU_CHNLDEC2,		0x003FFFFD },		// The goal is randomize the channel in most cases to create a balanced distribution.
