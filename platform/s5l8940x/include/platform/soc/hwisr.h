...
#define INT_ETH			27	// Ethernet Interrupt
#else
...
#if SUB_PLATFORM_S5L8947X
#define INT_USB_DEV_RES		32	// USB PHY1 Interrupt
#else
...
#if SUB_PLATFORM_S5L8947X
#define INT_USB_DEV_OTG		35	// USB OTG1 Interrupt
#define INT_USB_DEV_EHCI	36	// USB EHCI1 Interrupt
#else
...
#define INT_MIPI_DSI		41	// MIPI DSI Interrupt	 	
...
#if SUB_PLATFORM_S5L8947X
#define INT_HDMI_LINK		46	// HDMI link Interrupt
#define INT_HDMI_CEC		47	// HDMI cec Interrupt
#else
