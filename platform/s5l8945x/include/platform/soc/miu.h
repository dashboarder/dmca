...
#define  CDIO_UPERF1_RTLIMIT		(0x00C8)
#define rCDIO_UPERF1_RTLIMIT		(*(volatile u_int32_t *)(CDIO_WIDGETS_BASE_ADDR + CDIO_UPERF1_RTLIMIT))
#define  CDIO_UPERF1_WTLIMIT		(0x00CC)
#define rCDIO_UPERF1_WTLIMIT		(*(volatile u_int32_t *)(CDIO_WIDGETS_BASE_ADDR + CDIO_UPER1F_WTLIMIT))
#define  CDIO_UPERF1_WGATHER		(0x00D0)
#define rCDIO_UPERF1_WGATHER		(*(volatile u_int32_t *)(CDIO_WIDGETS_BASE_ADDR + CDIO_UPERF1_WGATHER))
...
#define rUPERF1_OTG_QOS			(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_OTG_QOS))
#define rUPERF1_OTG_CACHE		(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_OTG_CACHE))
#define rUPERF1_EHCI_QOS		(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_EHCI_QOS))
#define rUPERF1_EHCI_CACHE		(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_EHCI_CACHE))
#define rUPERF1_OHCI0_QOS		(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_OHCI0_QOS))
#define rUPERF1_OHCI0_CACHE		(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_OHCI0_CACHE))
#define rUPERF1_OHCI1_QOS		(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_OHCI1_QOS))
#define rUPERF1_OHCI1_CACHE		(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_OHCI1_CACHE))
#define rUPERF1_RTLIMIT			(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_RTLIMIT))
#define rUPERF1_WTLIMIT			(*(volatile u_int32_t *)(UPERF1_WIDGETS_BASE_ADDR + UPERF_WTLIMIT))
