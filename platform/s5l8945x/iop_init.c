...
platform_early_init()
{
	...
	rPMGR_PWR_GATE_CTL_CLR = rPMGR_PWR_GATE_IOP;
	while (rPMGR_PWR_GATE_CTL_CLR & rPMGR_PWR_GATE_IOP) ;
#endif
...
{
	rPMGR_PWR_GATE_CTL_SET = rPMGR_PWR_GATE_IOP;
	while (!(rPMGR_PWR_GATE_CTL_SET & rPMGR_PWR_GATE_IOP)) ;
	a5iop_sleep(1);
	rPMGR_PWR_GATE_CTL_CLR = rPMGR_PWR_GATE_IOP;
	while (rPMGR_PWR_GATE_CTL_CLR & rPMGR_PWR_GATE_IOP) ;
}
