...
#define  CDIO_DAP_QOS			(0x4014)
#define rCDIO_DAP_QOS			(*(volatile u_int32_t *)(CDIO_WIDGETS_BASE_ADDR + CDIO_DAP_QOS))
#define  CDIO_DAP_CACHE			(0x4018)
#define rCDIO_DAP_CACHE			(*(volatile u_int32_t *)(CDIO_WIDGETS_BASE_ADDR + CDIO_DAP_CACHE))
