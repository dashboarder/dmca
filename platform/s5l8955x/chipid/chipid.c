...
#if SUB_PLATFORM_S5L8955X
// Based on H5P/H5G tunables v0.63 and H5G Test Plan rev 1.5
#define MINIMUM_BINNING_VERSION	(2)
static u_int32_t default_soc_voltages[CHIPID_SOC_VOLTAGE_COUNT] = { 980, 1030, 1130 };
								/* 600, 1008, 1200, 1296, 1396  -  -  - MHz */
static u_int32_t default_cpu_voltages[CHIPID_CPU_VOLTAGE_COUNT] = { 810, 1020, 1100, 1145, 1180, 0, 0, 0};
...
u_int32_t chipid_get_ram_voltage(u_int32_t index)
{
	...
	ram_voltage = default_ram_voltages[index];
