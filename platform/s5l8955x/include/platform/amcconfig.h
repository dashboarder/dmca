...
static const struct amc_param amc_params = {
	.flags     	 	= (FLAG_AMC_PARAM_BUSTAT23 | FLAG_AMC_PARAM_SLOW_BOOT | FLAG_AMC_PARAM_RECONFIG | FLAG_AMC_PARAM_ENABLE_AIU | FLAG_AMC_PARAM_MRR_BYTE_SWIZZLE),
...
static const struct amc_tunable amc_tunables[] = {
	...
	{ &rAMC_AIU_CHNLDEC2,		0x00155555 },
	{ &rAMC_AIU_CHNLDEC4,		0x002AAAAA },
	...
	{ &rAMC_AIU_RDMAXCRD,		0x1912047F },		// RT:NRT:CPU:GFX = 25:18:04:MAX
	{ &rAMC_AIU_RDREFL,		0x140f037f },		// 5/6 of AIURDMAXCRD fields
	{ &rAMC_AIU_WRMAXCRD,		0x1912047f },		// RT:NRT:CPU:GFX = 25:18:04:MAX
	{ &rAMC_AIU_WRREFL,		0x140f037f },		// 5/6 of AIUWRMAXCRD fields
	...
	{ &rAMC_PSQWQCTL1,		0x00000180 },		// optimized for 4 channels
	{ &rAMC_PWRMNGTPARAM,		0x03001000 },		// optimized for 4 channels	
};
#endif
