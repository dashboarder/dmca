...
int platform_early_init(void)
{
	...
	/* initialize the s5l8955x pmgr driver */
	platform_power_init();
#endif
...
{
	// Only support B0 and later
	if (platform_get_chip_revision() < 0x10) {
...
#if WITH_HW_PLATFORM_CHIPID
	if (platform_get_chip_revision() < 0x10) {
		if (FindNode(0, "arm-io/clcd", &node)) {
			propName = "enable-aap";
			if (FindProperty(node, &propName, &propData, &propSize)) {
				propName[0] = '~';
			}
...
bool platform_get_boot_device(int32_t index, enum boot_device *boot_device, u_int32_t *boot_flag, u_int32_t *boot_arg)
{
	...
	/* S5L8955X supports one boot device then USB-DFU per boot config */
...
{
#if SUPPORT_FPGA
	{ GPIO(14, 3), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// SPI0_SSIN
#else
	{ GPIO(14, 3), GPIO_CFG_OUT_1, GPIO_CFG_DFLT },	// SPI0_SSIN
#endif
	{ GPIO(14, 0), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// SPI0_SCLK
	{ GPIO(14, 1), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// SPI0_MOSI
	{ GPIO(14, 2), GPIO_CFG_FUNC0, GPIO_CFG_DFLT }	// SPI0_MISO
};

static const struct boot_interface_pin spi3_boot_interface_pins[] =
{
#if SUPPORT_FPGA
	{ GPIO(28, 4), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// SPI3_SSIN
#else
	{ GPIO(28, 4), GPIO_CFG_OUT_1, GPIO_CFG_DFLT },	// SPI3_SSIN
#endif
	{ GPIO(28, 0), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// SPI3_SCLK
	{ GPIO(28, 1), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// SPI3_MOSI
	{ GPIO(28, 2), GPIO_CFG_FUNC0, GPIO_CFG_DFLT }	// SPI3_MISO
};
...
{
	{ GPIO( 5, 6), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_CEN3
	{ GPIO( 5, 7), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_CEN2
	{ GPIO( 6, 0), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_CEN1
	{ GPIO( 6, 1), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_CEN0
	{ GPIO( 6, 2), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_CLE
	{ GPIO( 6, 3), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_ALE
	{ GPIO( 6, 4), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_REN
	{ GPIO( 6, 5), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_WEN
	{ GPIO( 8, 0), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_IO0
	{ GPIO( 7, 7), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_IO1
	{ GPIO( 7, 6), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_IO2
	{ GPIO( 7, 5), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_IO3
	{ GPIO( 7, 2), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_IO4
	{ GPIO( 7, 1), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_IO5
	{ GPIO( 7, 0), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI0_IO6
	{ GPIO( 6, 7), GPIO_CFG_FUNC0, GPIO_CFG_DFLT }	// FMI0_IO7
};

/* Note: The code below expects this table to begin with CS3 through CS0 */
static const struct boot_interface_pin fmi1_boot_interface_pins[] =
{
	{ GPIO( 8, 5), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_CEN3
	{ GPIO( 8, 6), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_CEN2
	{ GPIO( 8, 7), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_CEN1
	{ GPIO( 9, 0), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_CEN0
	{ GPIO( 9, 1), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_CLE
	{ GPIO( 9, 2), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_ALE
	{ GPIO( 9, 3), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_REN
	{ GPIO( 9, 4), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_WEN
	{ GPIO(10, 7), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_IO0
	{ GPIO(10, 6), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_IO1
	{ GPIO(10, 5), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_IO2
	{ GPIO(10, 4), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_IO3
	{ GPIO(10, 1), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_IO4
	{ GPIO(10, 0), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_IO5
	{ GPIO( 9, 7), GPIO_CFG_FUNC0, GPIO_CFG_DFLT },	// FMI1_IO6
	{ GPIO( 9, 6), GPIO_CFG_FUNC0, GPIO_CFG_DFLT }	// FMI1_IO7
};
