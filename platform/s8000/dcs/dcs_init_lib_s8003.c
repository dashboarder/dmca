...
void dcs_enable_autorefresh(void)
{
	...
	dcs_reg_write_all_chan(rDCS_MCU_AREFEN_FREQ(3), 0x11100000);
	dcs_reg_write_all_chan(rDCS_MCU_AREFEN_FREQ(2), 0x11000000);
	dcs_reg_write_all_chan(rDCS_MCU_AREFEN_FREQ(1), 0x11110000);
	dcs_reg_write_all_chan(rDCS_MCU_AREFEN_FREQ(0), 0x1111013f);
}
...
void dcs_init_AMP_Initial_Config(void)
{
	...
	dcs_reg_write_all_chan(rDCS_AMP_MAXWRDQ_SDLL_MULFACTOR, 0x00a00a0f);
...
// AMPH configuration
	...
	dcs_reg_write_all_chan(rDCS_AMPH_B0_IMPCTL,       0x00201c2b);
	...
	dcs_reg_write_all_chan(rDCS_AMPH_B1_IMPCTL,       0x00201c2b);
	...
	dcs_reg_write_all_chan(rDCS_AMPH_DQS0_WKPUPD,	  0x00000788);
	dcs_reg_write_all_chan(rDCS_AMPH_DQS0_DRIVESTR,   dcs_params.dqs0drivestr);
	dcs_reg_write_all_chan(rDCS_AMPH_DQS0_IMPCTL,     0x00201c2b);
	...
	dcs_reg_write_all_chan(rDCS_AMPH_DQS1_WKPUPD,	  0x00000788);
	dcs_reg_write_all_chan(rDCS_AMPH_DQS1_DRIVESTR,   dcs_params.dqs1drivestr);
	dcs_reg_write_all_chan(rDCS_AMPH_DQS1_IMPCTL,     0x00201c2b);
...
{
	if (dcs_cfg.chipRev > CHIP_REVISION_A0)
		dcs_reg_write_all_chan(rDCS_AMPH_SPARE(0), 0x0000040e);
...
void dcs_init_MoreFeatures(void)
{
	...
	dcs_reg_write_all_chan(rDCS_AMPH_DQS0_DCD_IOCTL, 0x00030000);
	dcs_reg_write_all_chan(rDCS_AMPH_DQS1_DCD_IOCTL, 0x00030000);
