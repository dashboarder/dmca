...
#define PMGR_BINNING_GROUP_N69		(0x1)
#define PMGR_BINNING_GROUP_J111		(0x2)

#define PMGR_BINNING_GROUP_N69U		(0x1)
...
#define PMGR_CLK_CFG_WAIT_COUNTER_UMASK (0xf00000)

#define PMGR_SPARE_COUNT		(6)
...
#define rPMGR_PWRGATE_MCC_CFG0		(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_MCC_CFG0_OFFSET))
#define rPMGR_PWRGATE_MCC_CFG1		(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_MCC_CFG1_OFFSET))
#define rPMGR_PWRGATE_MCC_CFG2		(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_MCC_CFG2_OFFSET))
#if SUB_PLATFORM_S8000 || SUB_PLATFORM_S8003
#define rPMGR_PWRGATE_DCS01_CFG0	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS01_CFG0_OFFSET))
#define rPMGR_PWRGATE_DCS01_CFG1	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS01_CFG1_OFFSET))
#define rPMGR_PWRGATE_DCS01_CFG2	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS01_CFG2_OFFSET))
#define rPMGR_PWRGATE_DCS23_CFG0	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS23_CFG0_OFFSET))
#define rPMGR_PWRGATE_DCS23_CFG1	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS23_CFG1_OFFSET))
#define rPMGR_PWRGATE_DCS23_CFG2	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS23_CFG2_OFFSET))
#elif SUB_PLATFORM_S8001
#define rPMGR_PWRGATE_DCS0123_CFG0	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS0123_CFG0_OFFSET))
#define rPMGR_PWRGATE_DCS0123_CFG1	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS0123_CFG1_OFFSET))
#define rPMGR_PWRGATE_DCS0123_CFG2	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS0123_CFG2_OFFSET))
#define rPMGR_PWRGATE_DCS4567_CFG0	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS4567_CFG0_OFFSET))
#define rPMGR_PWRGATE_DCS4567_CFG1	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS4567_CFG1_OFFSET))
#define rPMGR_PWRGATE_DCS4567_CFG2	(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_DCS4567_CFG2_OFFSET))
#endif
#define rPMGR_PWRGATE_ACS_CFG0		(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_ACS_CFG0_OFFSET))
#define rPMGR_PWRGATE_ACS_CFG1		(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_ACS_CFG1_OFFSET))
#define rPMGR_PWRGATE_ACS_CFG2		(*(volatile uint32_t *) (PMGR_BASE_ADDR + PMGR_PWRGATE_PWR_ACS_CFG2_OFFSET))
...
#define rMINIPMGR_SCRATCH11		rMINIPMGR_SCRATCH(11)		/* Reconfig sequence debug */


#define  PMGR_THERMAL0_CTL0_SET		(PMGR_BASE_ADDR + PMGR_THERMAL_0_CTL0_SET_OFFSET)
#define  PMGR_THERMAL0_CTL0_CLR		(PMGR_BASE_ADDR + PMGR_THERMAL_0_CTL0_CLR_OFFSET)
#define  PMGR_THERMAL0_CTL1		(PMGR_BASE_ADDR + PMGR_THERMAL_0_CTL1_OFFSET)
#define  PMGR_THERMAL0_CTL2		(PMGR_BASE_ADDR + PMGR_THERMAL_0_CTL2_OFFSET)
#define  PMGR_THERMAL0_STATUS		(PMGR_BASE_ADDR + PMGR_THERMAL_0_STATUS_OFFSET)
#define  PMGR_THERMAL0_PARAM		(PMGR_BASE_ADDR + PMGR_THERMAL_0_PARAM_OFFSET)
#define  PMGR_THERMAL0_RDBK0		(PMGR_BASE_ADDR + PMGR_THERMAL_0_RDBK0_OFFSET)
#define  PMGR_THERMAL0_RDBK1		(PMGR_BASE_ADDR + PMGR_THERMAL_0_RDBK1_OFFSET)
#define  PMGR_THERMAL0_SUM		(PMGR_BASE_ADDR + PMGR_THERMAL_0_SUM_OFFSET)
#define  PMGR_THERMAL0_SUM_CNT		(PMGR_BASE_ADDR + PMGR_THERMAL_0_SUM_CNT_OFFSET)
#define  PMGR_THERMAL0_PIECE0		(PMGR_BASE_ADDR + PMGR_THERMAL_0_PIECE0_OFFSET)
#define  PMGR_THERMAL0_PIECE1		(PMGR_BASE_ADDR + PMGR_THERMAL_0_PIECE1_OFFSET)
#define  PMGR_THERMAL0_PIECE2		(PMGR_BASE_ADDR + PMGR_THERMAL_0_PIECE2_OFFSET)
#define  PMGR_THERMAL0_ALARM0		(PMGR_BASE_ADDR + PMGR_THERMAL_0_ALARM0_OFFSET)
#define  PMGR_THERMAL0_ALARM1		(PMGR_BASE_ADDR + PMGR_THERMAL_0_ALARM1_OFFSET)
#define  PMGR_THERMAL0_ALARM2		(PMGR_BASE_ADDR + PMGR_THERMAL_0_ALARM2_OFFSET)
#define  PMGR_THERMAL0_ALARM3		(PMGR_BASE_ADDR + PMGR_THERMAL_0_ALARM3_OFFSET)
#define  PMGR_THERMAL0_FAILSAFE_TRIP_TEMP_0	(PMGR_BASE_ADDR + PMGR_THERMAL_0_FAILSAFE_TRIP_TEMP_0_OFFSET)
#define  PMGR_THERMAL0_FAILSAFE_TRIP_TEMP_1	(PMGR_BASE_ADDR + PMGR_THERMAL_0_FAILSAFE_TRIP_TEMP_1_OFFSET)
#define  PMGR_THERMAL1_CTL0_SET		(PMGR_BASE_ADDR + PMGR_THERMAL_1_CTL0_SET_OFFSET)
#define  PMGR_THERMAL1_CTL0_CLR		(PMGR_BASE_ADDR + PMGR_THERMAL_1_CTL0_CLR_OFFSET)
#define  PMGR_THERMAL1_CTL1		(PMGR_BASE_ADDR + PMGR_THERMAL_1_CTL1_OFFSET)
#define  PMGR_THERMAL1_CTL2		(PMGR_BASE_ADDR + PMGR_THERMAL_1_CTL2_OFFSET)
#define  PMGR_THERMAL1_STATUS		(PMGR_BASE_ADDR + PMGR_THERMAL_1_STATUS_OFFSET)
#define  PMGR_THERMAL1_PARAM		(PMGR_BASE_ADDR + PMGR_THERMAL_1_PARAM_OFFSET)
#define  PMGR_THERMAL1_RDBK0		(PMGR_BASE_ADDR + PMGR_THERMAL_1_RDBK0_OFFSET)
#define  PMGR_THERMAL1_RDBK1		(PMGR_BASE_ADDR + PMGR_THERMAL_1_RDBK1_OFFSET)
#define  PMGR_THERMAL1_SUM		(PMGR_BASE_ADDR + PMGR_THERMAL_1_SUM_OFFSET)
#define  PMGR_THERMAL1_SUM_CNT		(PMGR_BASE_ADDR + PMGR_THERMAL_1_SUM_CNT_OFFSET)
#define  PMGR_THERMAL1_PIECE0		(PMGR_BASE_ADDR + PMGR_THERMAL_1_PIECE0_OFFSET)
#define  PMGR_THERMAL1_PIECE1		(PMGR_BASE_ADDR + PMGR_THERMAL_1_PIECE1_OFFSET)
#define  PMGR_THERMAL1_PIECE2		(PMGR_BASE_ADDR + PMGR_THERMAL_1_PIECE2_OFFSET)
#define  PMGR_THERMAL1_ALARM0		(PMGR_BASE_ADDR + PMGR_THERMAL_1_ALARM0_OFFSET)
#define  PMGR_THERMAL1_ALARM1		(PMGR_BASE_ADDR + PMGR_THERMAL_1_ALARM1_OFFSET)
#define  PMGR_THERMAL1_ALARM2		(PMGR_BASE_ADDR + PMGR_THERMAL_1_ALARM2_OFFSET)
#define  PMGR_THERMAL1_ALARM3		(PMGR_BASE_ADDR + PMGR_THERMAL_1_ALARM3_OFFSET)
#define  PMGR_THERMAL1_FAILSAFE_TRIP_TEMP_0	(PMGR_BASE_ADDR + PMGR_THERMAL_1_FAILSAFE_TRIP_TEMP_0_OFFSET)
#define  PMGR_THERMAL1_FAILSAFE_TRIP_TEMP_1	(PMGR_BASE_ADDR + PMGR_THERMAL_1_FAILSAFE_TRIP_TEMP_1_OFFSET)
#define  PMGR_THERMAL2_CTL0_SET		(PMGR_BASE_ADDR + PMGR_THERMAL_2_CTL0_SET_OFFSET)
#define  PMGR_THERMAL2_CTL0_CLR		(PMGR_BASE_ADDR + PMGR_THERMAL_2_CTL0_CLR_OFFSET)
#define  PMGR_THERMAL2_CTL1		(PMGR_BASE_ADDR + PMGR_THERMAL_2_CTL1_OFFSET)
#define  PMGR_THERMAL2_CTL2		(PMGR_BASE_ADDR + PMGR_THERMAL_2_CTL2_OFFSET)
#define  PMGR_THERMAL2_STATUS		(PMGR_BASE_ADDR + PMGR_THERMAL_2_STATUS_OFFSET)
#define  PMGR_THERMAL2_PARAM		(PMGR_BASE_ADDR + PMGR_THERMAL_2_PARAM_OFFSET)
#define  PMGR_THERMAL2_RDBK0		(PMGR_BASE_ADDR + PMGR_THERMAL_2_RDBK0_OFFSET)
#define  PMGR_THERMAL2_RDBK1		(PMGR_BASE_ADDR + PMGR_THERMAL_2_RDBK1_OFFSET)
#define  PMGR_THERMAL2_SUM		(PMGR_BASE_ADDR + PMGR_THERMAL_2_SUM_OFFSET)
#define  PMGR_THERMAL2_SUM_CNT		(PMGR_BASE_ADDR + PMGR_THERMAL_2_SUM_CNT_OFFSET)
#define  PMGR_THERMAL2_PIECE0		(PMGR_BASE_ADDR + PMGR_THERMAL_2_PIECE0_OFFSET)
#define  PMGR_THERMAL2_PIECE1		(PMGR_BASE_ADDR + PMGR_THERMAL_2_PIECE1_OFFSET)
#define  PMGR_THERMAL2_PIECE2		(PMGR_BASE_ADDR + PMGR_THERMAL_2_PIECE2_OFFSET)
#define  PMGR_THERMAL2_ALARM0		(PMGR_BASE_ADDR + PMGR_THERMAL_2_ALARM0_OFFSET)
#define  PMGR_THERMAL2_ALARM1		(PMGR_BASE_ADDR + PMGR_THERMAL_2_ALARM1_OFFSET)
#define  PMGR_THERMAL2_ALARM2		(PMGR_BASE_ADDR + PMGR_THERMAL_2_ALARM2_OFFSET)
#define  PMGR_THERMAL2_ALARM3		(PMGR_BASE_ADDR + PMGR_THERMAL_2_ALARM3_OFFSET)
#define  PMGR_THERMAL2_FAILSAFE_TRIP_TEMP_0	(PMGR_BASE_ADDR + PMGR_THERMAL_2_FAILSAFE_TRIP_TEMP_0_OFFSET)
#define  PMGR_THERMAL2_FAILSAFE_TRIP_TEMP_1	(PMGR_BASE_ADDR + PMGR_THERMAL_2_FAILSAFE_TRIP_TEMP_1_OFFSET)
#if SUB_PLATFORM_S8001
#define  PMGR_THERMAL3_CTL0_SET		(PMGR_BASE_ADDR + PMGR_THERMAL_3_CTL0_SET_OFFSET)
#define  PMGR_THERMAL3_CTL0_CLR		(PMGR_BASE_ADDR + PMGR_THERMAL_3_CTL0_CLR_OFFSET)
#define  PMGR_THERMAL3_CTL1		(PMGR_BASE_ADDR + PMGR_THERMAL_3_CTL1_OFFSET)
#define  PMGR_THERMAL3_CTL2		(PMGR_BASE_ADDR + PMGR_THERMAL_3_CTL2_OFFSET)
#define  PMGR_THERMAL3_STATUS		(PMGR_BASE_ADDR + PMGR_THERMAL_3_STATUS_OFFSET)
#define  PMGR_THERMAL3_PARAM		(PMGR_BASE_ADDR + PMGR_THERMAL_3_PARAM_OFFSET)
#define  PMGR_THERMAL3_RDBK0		(PMGR_BASE_ADDR + PMGR_THERMAL_3_RDBK0_OFFSET)
#define  PMGR_THERMAL3_RDBK1		(PMGR_BASE_ADDR + PMGR_THERMAL_3_RDBK1_OFFSET)
#define  PMGR_THERMAL3_SUM		(PMGR_BASE_ADDR + PMGR_THERMAL_3_SUM_OFFSET)
#define  PMGR_THERMAL3_SUM_CNT		(PMGR_BASE_ADDR + PMGR_THERMAL_3_SUM_CNT_OFFSET)
#define  PMGR_THERMAL3_PIECE0		(PMGR_BASE_ADDR + PMGR_THERMAL_3_PIECE0_OFFSET)
#define  PMGR_THERMAL3_PIECE1		(PMGR_BASE_ADDR + PMGR_THERMAL_3_PIECE1_OFFSET)
#define  PMGR_THERMAL3_PIECE2		(PMGR_BASE_ADDR + PMGR_THERMAL_3_PIECE2_OFFSET)
#define  PMGR_THERMAL3_ALARM0		(PMGR_BASE_ADDR + PMGR_THERMAL_3_ALARM0_OFFSET)
#define  PMGR_THERMAL3_ALARM1		(PMGR_BASE_ADDR + PMGR_THERMAL_3_ALARM1_OFFSET)
#define  PMGR_THERMAL3_ALARM2		(PMGR_BASE_ADDR + PMGR_THERMAL_3_ALARM2_OFFSET)
#define  PMGR_THERMAL3_ALARM3		(PMGR_BASE_ADDR + PMGR_THERMAL_3_ALARM3_OFFSET)
#define  PMGR_THERMAL3_FAILSAFE_TRIP_TEMP_0	(PMGR_BASE_ADDR + PMGR_THERMAL_3_FAILSAFE_TRIP_TEMP_0_OFFSET)
#define  PMGR_THERMAL3_FAILSAFE_TRIP_TEMP_1	(PMGR_BASE_ADDR + PMGR_THERMAL_3_FAILSAFE_TRIP_TEMP_1_OFFSET)
#endif

#define rPMGR_THERMAL0_PARAM		(*(volatile u_int32_t *)PMGR_THERMAL0_PARAM)
#define rPMGR_THERMAL1_PARAM		(*(volatile u_int32_t *)PMGR_THERMAL1_PARAM)
#define rPMGR_THERMAL2_PARAM		(*(volatile u_int32_t *)PMGR_THERMAL2_PARAM)
#if SUB_PLATFORM_S8001
#define rPMGR_THERMAL3_PARAM		(*(volatile u_int32_t *)PMGR_THERMAL3_PARAM)
#endif
...
#define rPMGR_MISC_PCIE_PCIE_CTL	(*(volatile uint32_t *)(PMGR_BASE_ADDR + PMGR_MISC_PCIE_PCIE_CTL_OFFSET))

#define rPMGR_MISC_SPARE0		(*(volatile uint32_t *)(PMGR_BASE_ADDR + PMGR_MISC_SPARE_SPARE0_OFFSET))

#define rPMGR_DEBUG_PMGR_DEBUG17	(*(volatile uint32_t *)(PMGR_BASE_ADDR + PMGR_DEBUG_17_OFFSET))
...
#define rMINIPMGR_LPO_CTL		(*(volatile uint32_t *)(AOP_MINIPMGR_BASE_ADDR + MINIPMGR_LPO_CTL_OFFSET))
#define	 MINIPMGR_LPO_CTL_ENABLE	(1 << MINIPMGR_LPO_CTL_ENABLE_SHIFT)
#define	 MINIPMGR_LPO_CTL_PENDING	(1 << MINIPMGR_LPO_CTL_PENDING_SHIFT)
#define rMINIPMGR_LPO_CFG		(*(volatile uint32_t *)(AOP_MINIPMGR_BASE_ADDR + MINIPMGR_LPO_CFG_OFFSET))
...
enum {
    ...
    PMGR_CLK_USB480_1,				// 0x13
    PMGR_CLK_USB_OHCI_48M,			// 0x14
    PMGR_CLK_USB,				// 0x15
    PMGR_CLK_USB_FREE_60M,			// 0x16
    PMGR_CLK_SIO_C,				// 0x17
    PMGR_CLK_SIO_P,				// 0x18
    PMGR_CLK_ISP_C,				// 0x19
    PMGR_CLK_ISP,				// 0x1A
    PMGR_CLK_ISP_SENSOR0_REF,			// 0x1B
    PMGR_CLK_ISP_SENSOR1_REF,			// 0x1C
    PMGR_CLK_VDEC,				// 0x1D
    PMGR_CLK_VENC,				// 0x1E
    PMGR_CLK_VID0,				// 0x1F
    PMGR_CLK_DISP0,				// 0x20
    PMGR_CLK_AJPEG_IP,				// 0x21
    PMGR_CLK_AJPEG_WRAP,			// 0x22
    PMGR_CLK_MSR,				// 0x23
    PMGR_CLK_AF,				// 0x24
    PMGR_CLK_SBR,				// 0x25
    PMGR_CLK_MCA0_M,				// 0x26
    PMGR_CLK_MCA1_M,				// 0x27
    PMGR_CLK_MCA2_M,				// 0x28
    PMGR_CLK_MCA3_M,				// 0x29
    PMGR_CLK_MCA4_M,				// 0x2A
    PMGR_CLK_SEP,				// 0x2B
    PMGR_CLK_GPIO,				// 0x2C
    PMGR_CLK_SPI0_N,				// 0x2D
    PMGR_CLK_SPI1_N,				// 0x2E
    PMGR_CLK_SPI2_N,				// 0x2F
    PMGR_CLK_SPI3_N,				// 0x30
    PMGR_CLK_PCIE_APP,				// 0x31
    PMGR_CLK_TMPS,				// 0x32
    PMGR_CLK_UVD,				// 0x33
    PMGR_CLK_LAST = PMGR_CLK_UVD,
    PMGR_CLK_S0,				// 0x34
    PMGR_CLK_SPARE_FIRST = PMGR_CLK_S0,
    PMGR_CLK_S1,				// 0x35
    PMGR_CLK_S2,				// 0x36
    PMGR_CLK_S3,				// 0x37
    PMGR_CLK_ISP_REF0,				// 0x38
    PMGR_CLK_ISP_REF1,				// 0x39
    PMGR_CLK_SPARE_LAST = PMGR_CLK_ISP_REF1,
    PMGR_CLK_LPO,				// 0x3A
    PMGR_CLK_AOP,				// 0x3B
    ...
    PMGR_CLK_UART1,				// 0x3D
    PMGR_CLK_UART2,				// 0x3E
    PMGR_CLK_AOP_MCA0_M,			// 0x3F
    PMGR_CLK_I2CM,				// 0x40
    PMGR_CLK_PROXY_FABRIC,			// 0x41
    PMGR_CLK_PROXY_MCU_REF,			// 0x42
...
enum {
    ...
    PMGR_CLK_PLL6,				// 0x07
    PMGR_CLK_PLL7,				// 0x08
    PMGR_CLK_PLL_PCIE,				// 0x09
    PMGR_CLK_CPU,				// 0x0A
    PMGR_CLK_GFX_FENDER,			// 0x0B
    PMGR_CLK_FIRST = PMGR_CLK_GFX_FENDER,
    PMGR_CLK_MCU_REF,				// 0x0C
    PMGR_CLK_PMP,				// 0x0D
    PMGR_CLK_NCO_REF0,				// 0x0E
    PMGR_CLK_NCO_REF1,				// 0x0F
    PMGR_CLK_NCO_ALG0,				// 0x10
    PMGR_CLK_NCO_ALG1,				// 0x11
    PMGR_CLK_HSICPHY_REF_12M,			// 0x12
    PMGR_CLK_USB480_0,				// 0x13
    PMGR_CLK_USB_OHCI_48M,			// 0x14
    PMGR_CLK_USB,				// 0x15
    PMGR_CLK_USB_FREE_60M,			// 0x16
    PMGR_CLK_SIO_C,				// 0x17
    ...
    PMGR_CLK_UART1,				// 0x40
    PMGR_CLK_UART2,				// 0x41
    PMGR_CLK_AOP_MCA0_M,			// 0x42
    PMGR_CLK_I2CM,				// 0x43
    PMGR_CLK_PROXY_FABRIC,			// 0x44
    PMGR_CLK_PROXY_MCU_REF,			// 0x45
    PMGR_CLK_MINI_LAST = PMGR_CLK_PROXY_MCU_REF,
    PMGR_CLK_COUNT,				// 0x46
    PMGR_CLK_NOT_SUPPORTED
};
...
#define rACC_MSTR_PLLCTL		(*(volatile uint32_t *)(ACC_BASE_ADDR + ACC_PWRCTL_MSTR_PLLCTL_OFFSET))
...
#define kDVFM_STATE_VMAX		(kDVFM_STATE_V6)
...
#define kDVFM_STATE_IBOOT_VCO_WA	(kDVFM_STATE_MAX_CNT - 1)
#define kDVFM_STATE_VCO_WA_MAX_CNT	(4)

#define rACC_DVFM_ST(_n)		(*(volatile uint64_t *)(ACC_BASE_ADDR + ACC_PWRCTL_DVFM_ST0_OFFSET + ((_n) < 8 ? ((_n) * 8) : 0x300 + (((_n) - 8) * 8))))
#define  ACC_DVFM_ST_SAFE_VOL(_sv)	(ACC_PWRCTL_DVFM_ST0_SAFE_VOL_INSRT((uint64_t)_sv))
#define  ACC_DVFM_ST_VOL_ADJ3(_va)	(ACC_PWRCTL_DVFM_ST0_VOL_ADJ3_INSRT((uint64_t)_va))
#define  ACC_DVFM_ST_VOL_ADJ2(_va)	(ACC_PWRCTL_DVFM_ST0_VOL_ADJ2_INSRT((uint64_t)_va))
#define  ACC_DVFM_ST_VOL_ADJ1(_va)	(ACC_PWRCTL_DVFM_ST0_VOL_ADJ1_INSRT((uint64_t)_va))
#define  ACC_DVFM_ST_VOL_ADJ0(_va)	(ACC_PWRCTL_DVFM_ST0_VOL_ADJ0_INSRT((uint64_t)_va))
#define  ACC_DVFM_ST_VOL_BYP(_vb)	(ACC_PWRCTL_DVFM_ST0_VOL_BYP_INSRT((uint64_t)_vb))
#define  ACC_DVFM_ST_CLK_SRC(_s)	(ACC_PWRCTL_DVFM_ST0_CLK_SRC_INSRT((uint64_t)_s))
#define  ACC_DVFM_ST_PLL_P(_p)		(ACC_PWRCTL_DVFM_ST0_PRE_DIV_P_INSRT((uint64_t)_p))
#define  ACC_DVFM_ST_PLL_M(_m)		(ACC_PWRCTL_DVFM_ST0_FBK_DIV_M_INSRT((uint64_t)_m))
#define  ACC_DVFM_ST_PLL_S(_s)		(ACC_PWRCTL_DVFM_ST0_PST_DIV_S_INSRT((uint64_t)_s))
#define  ACC_DVFM_ST_PLL_PMS_MASK	(ACC_PWRCTL_DVFM_ST0_PRE_DIV_P_UMASK | ACC_PWRCTL_DVFM_ST0_FBK_DIV_M_UMASK | ACC_PWRCTL_DVFM_ST0_PST_DIV_S_UMASK)
...
#define rACC_DVMR_SCR			(*(volatile uint64_t *)(ACC_BASE_ADDR + ACC_PWRCTL_DVMR_SCR_OFFSET))

#define rACC_DVFM_ST_EXT(_n)		(*(volatile uint64_t *)(ACC_BASE_ADDR + ACC_PWRCTL_DVFM_ST0_EXT_OFFSET + ((_n) * 8)))
#define  ACC_DVFM_ST_BIU_DIV_HI_VOL(_d)	(ACC_PWRCTL_DVFM_ST0_EXT_BIU_DIV4_HI_VOL_INSRT((uint64_t)(_d)))
#define  ACC_DVFM_ST_BIU_DIV_LO_VOL(_d)	(ACC_PWRCTL_DVFM_ST0_EXT_BIU_DIV4_LO_VOL_INSRT((uint64_t)(_d)))
#define  ACC_DVFM_ST_DVMR_MAX_WGT(_w)	(ACC_PWRCTL_DVFM_ST0_EXT_DVMR_MAX_WGT_INSRT((uint64_t)(_w)))
#define  ACC_DVFM_ST_SRAM_VOL(_v)	(ACC_PWRCTL_DVFM_ST0_EXT_SRAM_VOL_INSRT((uint64_t)(_v)))
#define  ACC_DVFM_ST_DVFM_MAX_ADJ(_a)	(ACC_PWRCTL_DVFM_ST0_EXT_DVFM_MAX_ADJ_INSRT((uint64_t)(_a)))
#define  ACC_DVFM_ST_DVMR_ADJ2(_a)	(ACC_PWRCTL_DVFM_ST0_EXT_DVMR_ADJ2_INSRT((uint64_t)(_a)))
#define  ACC_DVFM_ST_DVMR_ADJ1(_a)	(ACC_PWRCTL_DVFM_ST0_EXT_DVMR_ADJ1_INSRT((uint64_t)(_a)))
#define  ACC_DVFM_ST_DVMR_ADJ0(_a)	(ACC_PWRCTL_DVFM_ST0_EXT_DVMR_ADJ0_INSRT((uint64_t)(_a)))

#define rACC_NRG_ACC_SCALE_TAB 	    (*(volatile uint64_t *)(ACC_BASE_ADDR + ACC_PWRCTL_NRG_ACC_SCALE_TAB_OFFSET))
#define rACC_NRG_ACC_SCALE_TAB_EXT  (*(volatile uint64_t *)(ACC_BASE_ADDR + ACC_PWRCTL_NRG_ACC_SCALE_TAB_EXT_OFFSET))
#define rACC_LKG_EST_TAB 			(*(volatile uint64_t *)(ACC_BASE_ADDR + ACC_PWRCTL_LKG_EST_TAB_OFFSET))
#define rACC_LKG_EST_TAB_EXT 		(*(volatile uint64_t *)(ACC_BASE_ADDR + ACC_PWRCTL_LKG_EST_TAB_EXT_OFFSET))
#define rACC_DPE0_DVFM_TAB          (*(volatile uint64_t *)(ACC_BASE_ADDR + ACC_PWRCTL_DPE0_DVFM_TAB_OFFSET))
#define rACC_DPE0_DVFM_TAB_EXT      (*(volatile uint64_t *)(ACC_BASE_ADDR + ACC_PWRCTL_DPE0_DVFM_TAB_EXT_OFFSET))

#define rPMGR_SECURITY			(*(volatile uint32_t *)(AOP_MINIPMGR_BASE_ADDR + 0xD0000))

#define  ACC_THRM0_CTL0_SET		(ACC_BASE_ADDR + ACC_THERMAL_THRM0_CTL0_SET_OFFSET)
#define  ACC_THRM0_CTL0_CLR		(ACC_BASE_ADDR + ACC_THERMAL_THRM0_CTL0_CLR_OFFSET)
#define  ACC_THRM0_CTL1			(ACC_BASE_ADDR + ACC_THERMAL_THRM0_CTL1_OFFSET)
#define  ACC_THRM0_PARAM		(ACC_BASE_ADDR + ACC_THERMAL_THRM0_PARAM_OFFSET)
#define  ACC_THRM0_PIECE0		(ACC_BASE_ADDR + ACC_THERMAL_THRM0_PIECE0_OFFSET)
#define  ACC_THRM0_PIECE1		(ACC_BASE_ADDR + ACC_THERMAL_THRM0_PIECE1_OFFSET)
#define  ACC_THRM0_PIECE2		(ACC_BASE_ADDR + ACC_THERMAL_THRM0_PIECE2_OFFSET)

#define  ACC_THRM1_CTL0_SET		(ACC_BASE_ADDR + ACC_THERMAL_THRM1_CTL0_SET_OFFSET)
#define  ACC_THRM1_CTL0_CLR		(ACC_BASE_ADDR + ACC_THERMAL_THRM1_CTL0_CLR_OFFSET)
#define  ACC_THRM1_CTL1			(ACC_BASE_ADDR + ACC_THERMAL_THRM1_CTL1_OFFSET)
#define  ACC_THRM1_PARAM		(ACC_BASE_ADDR + ACC_THERMAL_THRM1_PARAM_OFFSET)
#define  ACC_THRM1_PIECE0		(ACC_BASE_ADDR + ACC_THERMAL_THRM1_PIECE0_OFFSET)
#define  ACC_THRM1_PIECE1		(ACC_BASE_ADDR + ACC_THERMAL_THRM1_PIECE1_OFFSET)
#define  ACC_THRM1_PIECE2		(ACC_BASE_ADDR + ACC_THERMAL_THRM1_PIECE2_OFFSET)

#define  ACC_THRM2_CTL0_SET		(ACC_BASE_ADDR + ACC_THERMAL_THRM2_CTL0_SET_OFFSET)
#define  ACC_THRM2_CTL0_CLR		(ACC_BASE_ADDR + ACC_THERMAL_THRM2_CTL0_CLR_OFFSET)
#define  ACC_THRM2_CTL1			(ACC_BASE_ADDR + ACC_THERMAL_THRM2_CTL1_OFFSET)
#define  ACC_THRM2_PARAM		(ACC_BASE_ADDR + ACC_THERMAL_THRM2_PARAM_OFFSET)
#define  ACC_THRM2_PIECE0		(ACC_BASE_ADDR + ACC_THERMAL_THRM2_PIECE0_OFFSET)
#define  ACC_THRM2_PIECE1		(ACC_BASE_ADDR + ACC_THERMAL_THRM2_PIECE1_OFFSET)
#define  ACC_THRM2_PIECE2		(ACC_BASE_ADDR + ACC_THERMAL_THRM2_PIECE2_OFFSET)

#define  ACC_DVFM_FSHOT_IDX		(ACC_BASE_ADDR + ACC_THERMAL_DVFM_FSHOT_IDX_OFFSET)

#define  ACC_THRM0_PIECE0_MAKE(_c, _o, _s)	(ACC_THERMAL_THRM0_PIECE0_START_CODE_INSRT(_c) | ACC_THERMAL_THRM0_PIECE0_OFFSET_INSRT(_o) | ACC_THERMAL_THRM0_PIECE0_SLOPE_INSRT(_s))
#define  ACC_THRM0_PIECE1_MAKE(_c, _o, _s)	(ACC_THERMAL_THRM0_PIECE1_START_CODE_INSRT(_c) | ACC_THERMAL_THRM0_PIECE1_OFFSET_INSRT(_o) | ACC_THERMAL_THRM0_PIECE1_SLOPE_INSRT(_s))
#define  ACC_THRM0_PIECE2_MAKE(_c, _o, _s)	(ACC_THERMAL_THRM0_PIECE2_START_CODE_INSRT(_c) | ACC_THERMAL_THRM0_PIECE2_OFFSET_INSRT(_o) | ACC_THERMAL_THRM0_PIECE2_SLOPE_INSRT(_s))
#define  ACC_THRM1_PIECE0_MAKE(_c, _o, _s)	(ACC_THERMAL_THRM1_PIECE0_START_CODE_INSRT(_c) | ACC_THERMAL_THRM1_PIECE0_OFFSET_INSRT(_o) | ACC_THERMAL_THRM1_PIECE0_SLOPE_INSRT(_s))
#define  ACC_THRM1_PIECE1_MAKE(_c, _o, _s)	(ACC_THERMAL_THRM1_PIECE1_START_CODE_INSRT(_c) | ACC_THERMAL_THRM1_PIECE1_OFFSET_INSRT(_o) | ACC_THERMAL_THRM1_PIECE1_SLOPE_INSRT(_s))
#define  ACC_THRM1_PIECE2_MAKE(_c, _o, _s)	(ACC_THERMAL_THRM1_PIECE2_START_CODE_INSRT(_c) | ACC_THERMAL_THRM1_PIECE2_OFFSET_INSRT(_o) | ACC_THERMAL_THRM1_PIECE2_SLOPE_INSRT(_s))
#define  ACC_THRM2_PIECE0_MAKE(_c, _o, _s)	(ACC_THERMAL_THRM2_PIECE0_START_CODE_INSRT(_c) | ACC_THERMAL_THRM2_PIECE0_OFFSET_INSRT(_o) | ACC_THERMAL_THRM2_PIECE0_SLOPE_INSRT(_s))
#define  ACC_THRM2_PIECE1_MAKE(_c, _o, _s)	(ACC_THERMAL_THRM2_PIECE1_START_CODE_INSRT(_c) | ACC_THERMAL_THRM2_PIECE1_OFFSET_INSRT(_o) | ACC_THERMAL_THRM2_PIECE1_SLOPE_INSRT(_s))
#define  ACC_THRM2_PIECE2_MAKE(_c, _o, _s)	(ACC_THERMAL_THRM2_PIECE2_START_CODE_INSRT(_c) | ACC_THERMAL_THRM2_PIECE2_OFFSET_INSRT(_o) | ACC_THERMAL_THRM2_PIECE2_SLOPE_INSRT(_s))
...
extern void pmgr_platform_config_uvwarn(void);
