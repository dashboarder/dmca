...
/* Default T7001 SoC Pin Configuration - Capri I/O Spreadsheet v10.29 */
...
/* Port  8 */
	...
	CFG_DISABLED,							// SPI0_SCLK		-> BOARD_ID0
	CFG_DISABLED,							// SPI0_MOSI		-> BOARD_ID1
	CFG_DISABLED,							// SPI0_MISO		-> BOARD_ID2
