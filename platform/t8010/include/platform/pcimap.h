...
/* T8010 specific bus/device/function and PCI base address map */

#include <platform/soc/hwregbase.h>

#define PCIE_PORT0_MEMORY_BASE		(PCIE_MEMORY_BASE_ADDR)
#define PCIE_PORT0_MEMORY_LEN		(0x00100000ULL)

#define NVME0_PCI_BDF			(PCI_BDF(1, 0, 0))
#define NVME0_BASE_ADDR			(PCIE_PORT0_MEMORY_BASE)
#define NVME0_SIZE			(0x00002000)
