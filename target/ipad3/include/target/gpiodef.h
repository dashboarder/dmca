...
#define GPIO_LCD_PWR_EN		GPIO(21, 1)

#define GPIO_RINGER_AB		GPIO( 0, 3)
...
/* Board Revision */
#define GPIO_BOARD_REV0		GPIO(17, 3)
#define GPIO_BOARD_REV1		GPIO(17, 4)
#define GPIO_BOARD_REV2		GPIO(17, 5)

/* which IICs to initialize */
#define IICS_MASK		(7)

/* D1974 watchdog tickle, 'KEEPACT' */
#define GPIO_WDOG_TICKLE	GPIO(7, 2)
