...
// rdar://problem/18371949 - ASPNAND_INDIRECTION_MEMORY and ASPNAND_LEGACY_INDIRECTION_MEMORY
// should be the same for all post-OkemoTaos targets
#if SUB_TARGET_J85
...
#define ASPNAND_INDIRECTION_MEMORY (4*1024*1024)
#define ASPNAND_LEGACY_INDIRECTION_MEMORY (2*1024*1024)
#elif SUB_TARGET_J85M
#define ASPNAND_INDIRECTION_MEMORY (4*1024*1024)
#define ASPNAND_LEGACY_INDIRECTION_MEMORY (4*1024*1024)
#elif SUB_TARGET_J86M
#define ASPNAND_INDIRECTION_MEMORY (4*1024*1024)
#define ASPNAND_LEGACY_INDIRECTION_MEMORY (4*1024*1024)
#elif SUB_TARGET_J87M
#define ASPNAND_INDIRECTION_MEMORY (4*1024*1024)
#define ASPNAND_LEGACY_INDIRECTION_MEMORY (4*1024*1024)
#else
#error  // need to add a value for any new subtarget
#endif
