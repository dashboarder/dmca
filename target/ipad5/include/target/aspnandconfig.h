...
#define ASPNAND_SLC_WRITE_DIES_IN_PARALLEL 4
#define ASPNAND_ERASE_DIES_IN_PARALLEL 8
...
#define ASPNAND_TLC_ERASE_DIES_IN_PARALLEL 4
#define ASPNAND_TLC_READ_DIES_IN_PARALLEL 4
...
#define ASPNAND_INDIRECTION_MEMORY (4*1024*1024)
#define ASPNAND_LEGACY_INDIRECTION_MEMORY (4*1024*1024)
