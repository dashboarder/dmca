...
{
	{ PMU_IIC_BUS, kD1972_LDO1,		0x0A },	// PP3V0_ALWAYS		3.00V
	{ PMU_IIC_BUS, kD1972_LDO2,		0x2A },	// PP1V7_VA_L19		1.70V
	{ PMU_IIC_BUS, kD1972_LDO3,		0x10 },	// PP3V3_USB		3.30V
	...
	{ PMU_IIC_BUS, kD1972_LDO8,		0x14 },	// PP3V0_PROX_ALS	3.00V

	// <rdar://problem/12061759>
	{ PMU_IIC_BUS, kD1972_TEST_MODE,	0x1D },
	{ PMU_IIC_BUS, 0xF5,			0x01 },
	{ PMU_IIC_BUS, kD1972_LDO9,		0x13 },	// PP3V0_VIB		3.10V
	{ PMU_IIC_BUS, 0xF5,			0x00 },
	{ PMU_IIC_BUS, kD1972_TEST_MODE,	0x00 },
	
	{ PMU_IIC_BUS, kD1972_LDO10,		0x0A },	// PP3V0_PROX_IRLED	3.00V
...
static const struct pmu_setup_struct pmu_ldo_cold_setup[] =
{
	...
	{ PMU_IIC_BUS, kD1972_ACTIVE2, 		0xF5 },	// Everything but LDO4, LDO6 on
	{ PMU_IIC_BUS, kD1972_ACTIVE3, 		0x23 },	// LDO16, LDO12, LDO11 on
...
static const struct pmu_setup_struct pmu_cold_init[] =
{
	/* Note: the following differences from OTP are intentional:
	   ...
	   - GPIO10 pullup
	*/
	{ PMU_IIC_BUS, kD1972_SYS_GPIO_2,	0x7A }, // BB_WAKE_AP		In, L High, Wake, No PU
	...
	{ PMU_IIC_BUS, kD1972_SYS_GPIO_12,	0x01 }, // PMU_TO_BB_VBUS_DET	Out 0, Push-Pull, VCC_MAIN
