...
OPTIONS	+= \
	WITH_HW_MIPI=1 \
	WITH_HW_AGC_MIPI=1 \
	TARGET_HS_2_LP_DATA_TIME=41 \
	TARGET_LP_2_HS_DATA_TIME=125 \
	TARGET_HS_2_LP_CLOCK_TIME=57 \
	TARGET_LP_2_HS_CLOCK_TIME=153
else ifeq ($(SUB_TARGET),n61)
OPTIONS	+= \
	WITH_HW_MIPI=1 \
	WITH_HW_AGC_MIPI=1 \
	TARGET_HS_2_LP_DATA_TIME=31 \
	TARGET_LP_2_HS_DATA_TIME=93 \
	TARGET_HS_2_LP_CLOCK_TIME=44 \
	TARGET_LP_2_HS_CLOCK_TIME=113
else
$(error Unsupported subtarget: $(SUB_TARGET))
endif
