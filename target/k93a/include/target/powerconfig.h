...
static const struct pmu_setup_struct pmu_ldo_warm_setup[] =
{
	...
	{ PMU_IIC_BUS, kD1946_LDO7,		0x03 },	// PP1V8_VIDEO		1.80V
...
static const struct pmu_setup_struct pmu_ldo_cold_setup[] =
{
	...
	{ PMU_IIC_BUS, kD1946_ACTIVE2, 		0xE9 }, // Everything but SD and ACC, LDO8
...
#define TARGET_BRICKID_FULL_SCALE	(5000 * 3)	// H4A has resistor divider for USB monitor
