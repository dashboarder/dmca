...
static const struct pmu_setup_struct pmu_ldo_cold_setup[] =
{
	...
	{ PMU_IIC_BUS, kD2255_LDO9_VSEL, 0x1E}, // LDO9 at 2.55V rdar://20437860 
};
...
//
// <rdar://19269873 N69 IO Spreadsheet
// <rdar://21492643 N69 PMU GPIO: Implement IOspreadsheet 0v15
static const struct pmu_setup_struct pmu_cold_init[] =
{
	...
	{ PMU_IIC_BUS, kD2255_GPIO2_CONF1,  (0<<6)|(1<<3)|(2<<1)|(0<<0) },	// I.AL.PD.NW*,  BB_TO_PMU_HOST_WAKE_L
	...
	{ PMU_IIC_BUS, kD2255_GPIO12_CONF1, (1<<6)|(2<<3)|(0<<1)|(0<<0) },	// O_OD.nR.NP.0  NC
	...
	{ PMU_IIC_BUS, kD2255_GPIO15_CONF2, (0<<3)|(2<<0) },			// VCC_MAIN, 10ms
	...
	{ PMU_IIC_BUS, kD2255_GPIO17_CONF1, (0<<6)|(1<<3)|(1<<1)|(0<<0) },	// I.AL.PU.NW,	WLAN_TO_PMU_PCIE_WAKE_L
	{ PMU_IIC_BUS, kD2255_GPIO17_CONF2, (1<<3)|(2<<0) },			// VBUCK3, 10ms
	{ PMU_IIC_BUS, kD2255_GPIO18_CONF1, (2<<6)|(0<<3)|(0<<1)|(0<<0) },	// O_PP.L.NP.0  NC
	...
	{ PMU_IIC_BUS, kD2255_GPIO20_CONF1, (3<<6)|(2<<3)|(2<<1)|(0<<0) },	// SS.RE.PD.NW  NC
    ...
    // Overrides for OTP-AI per <rdar://problem/19869417> N69m iBoot driver update
	{ PMU_IIC_BUS, kDIALOG_TEST_ACCESS,		kDIALOG_TEST_ACCESS_ENA },	// enable test register access

	{ PMU_IIC_BUS, kD2255_BUCK1_ANA_TRIM10, 0x69 },
	{ PMU_IIC_BUS, kD2255_BUCK1_CLK_TRIM1,  0x01 },
	{ PMU_IIC_BUS, kD2255_BUCK1_CLK_TRIM2,  0x05 },
	{ PMU_IIC_BUS, kD2255_BUCK1_CLK_TRIM3,  0x0F },
	{ PMU_IIC_BUS, kD2255_BUCK2_MINV, 0x8 },            // <rdar://problem/21472020> Lower BUCK2_MINV

    // Set Buck5 Current
	{ PMU_IIC_BUS, kD2255_BUCK5_ANA_TRIM14, 0x36 },	    // Malta ILIM at 1.80A Max Load at 1.43 rdar://19846032
	...
	{ PMU_IIC_BUS, kD2255_PWRONOFF_LDO8_EN, 0x1}, 			// enable Vibrator rdar://20643930
