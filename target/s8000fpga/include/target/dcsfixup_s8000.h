...
void dcs_init_config_fixup_params(dcs_config_params_t *dcs_params, dcs_target_t targtype)
{
	...
	if(chip_rev < CHIP_REVISION_B0) {
		dcs_params->freq[0].freqchngctl[1]          = 0x000b110c;
		dcs_params->freq[1].freqchngctl[1]          = 0x000b110c;
		dcs_params->freq[0].selfref                 = 0x02001012;
		dcs_params->freq[1].selfref                 = 0x02001012;
		dcs_params->freq[2].selfref                 = 0x02001012;
		dcs_params->freq[3].selfref                 = 0x02001012;
	} else {
