...
void dcs_init_config_fixup_params(dcs_config_params_t *dcs_params, dcs_target_t targtype)
{
	...
	dcs_params->autoref_params2       = 0x002f0013;
	dcs_params->mr13cmd_step15       = 0x50,
	dcs_params->odtszqc              = 0x00000000;
	dcs_params->odtszqc2             = 0xc0000000;
	dcs_params->qbrparam             = 0x00000000;
// Commenting the pwrmngten fixup b/c DV thinks this is a mistake in the spec
//	dcs_params->pwrmngten            = 0x00000132;
