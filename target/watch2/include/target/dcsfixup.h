...
void dcs_init_config_fixup_params(dcs_config_params_t *dcs_params, dcs_target_t targtype)
{
	...
	dcs_params->freq[1].lat2         = 0x00111206;
	...
	dcs_params->autoref_params2       = 0x00200013;
	dcs_params->mr13cmd_step15       = 0x50,
	dcs_params->odtszqc              = 0x00002000;
	dcs_params->odtszqc2             = 0xc0002000;
