...
/* THIS FILE IS AUTOMATICALLY GENERATED BY tools/csvtopinconfig.py. DO NOT EDIT!
   I/O Spreadsheet version: rev 0.3.6
   I/O Spreadsheet tracker: 15171729
   Conversion command: csvtopinconfig.py --soc m7 --radar 15171729 --prefix proto2b <filename>
*/
...
static const uint32_t pinconfig_proto2b_ap_0[GPIO_GROUP_COUNT * GPIOPADPINS] = {
...
/* Port  9 */
	CFG_DISABLED,							//  72 : GPIO[17]	-> TP_AP_GPIO17
...
static const uint32_t pinconfig_proto2b_ap_1[GPIO_1_GROUP_COUNT * GPIOPADPINS] = {
...
static const uint32_t pinconfig_proto2b_dev_0[GPIO_GROUP_COUNT * GPIOPADPINS] = {
...
static const uint32_t pinconfig_proto2b_dev_1[GPIO_1_GROUP_COUNT * GPIOPADPINS] = {
...
static const struct pinconfig_map cfg_map[] = {
	{ 0, 1, { pinconfig_proto2b_ap_0, pinconfig_proto2b_ap_1 } },
	{ 1, 1, { pinconfig_proto2b_dev_0, pinconfig_proto2b_dev_1 } },
};

const uint32_t * target_get_proto2b_gpio_cfg(int gpioc)
{
